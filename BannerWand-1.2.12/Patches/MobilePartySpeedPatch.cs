...
namespace BannerWandRetro.Patches
{
    ...
    public static class MobilePartySpeedPatch
    {
        ...
        /// <summary>
        /// Tracks whether the patch has been successfully applied.
        /// </summary>
        private static bool _isPatchApplied = false;

        /// <summary>
        /// Checks if the MobilePartySpeedPatch is active (patch applied and cheat enabled).
        /// </summary>
        /// <returns>True if the patch is active, false otherwise.</returns>
        public static bool IsActive()
        {
            return _isPatchApplied && Settings != null && TargetSettings != null &&
                   (Settings.MovementSpeed > 0f || Settings.NPCMovementSpeed > 0f);
        }

        /// <summary>
        /// Sets the patch as applied. Called by HarmonyManager after successful patch application.
        /// </summary>
        internal static void SetPatchApplied(bool applied)
        {
            _isPatchApplied = applied;
        }
        ...
        /// </summary>
        private static readonly TextObject SpeedBonusText = new("BannerWand Speed Bonus");
