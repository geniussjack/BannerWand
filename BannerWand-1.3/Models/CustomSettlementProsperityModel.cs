...
namespace BannerWand.Models
{
    ...
    public class CustomSettlementProsperityModel : DefaultSettlementProsperityModel
    {
        ...
        public override ExplainedNumber CalculateProsperityChange(Town fortification, bool includeDescriptions = false)
        {
            ...
            {
                ModLogger.Error($"[CustomSettlementProsperityModel] Error in CalculateProsperityChange: {ex.Message}");
        ...
        public override ExplainedNumber CalculateHearthChange(Village village, bool includeDescriptions = false)
        {
            ...
            {
                ModLogger.Error($"[CustomSettlementProsperityModel] Error in CalculateHearthChange: {ex.Message}");
                ModLogger.Error($"Stack trace: {ex.StackTrace}");
