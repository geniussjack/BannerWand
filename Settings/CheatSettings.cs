...
namespace BannerWand.Settings
{
    ...
    public class CheatSettings : AttributeGlobalSettings<CheatSettings>
    {
        ...
        /// </summary>
        [SettingPropertyInteger("{=BW_Player_PartySizeLimit}Party Size Limit Bonus", 0, 500, Order = 7, RequireRestart = false, HintText = "{=BW_Player_PartySizeLimit_Hint}Adds bonus to party size limit for player's party only. Does not affect clan parties or NPC parties.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
        ...
        /// </summary>
        [SettingPropertyBool("{=BW_Player_BarterAlwaysAccepted}Barter Offer Always Accepted", Order = 8, RequireRestart = false, HintText = "{=BW_Player_BarterAlwaysAccepted_Hint}All barter offers are automatically accepted.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
        ...
        /// </summary>
        [SettingPropertyBool("{=BW_Player_UnlimitedSmithyStamina}Unlimited Smithy Stamina", Order = 9, RequireRestart = false, HintText = "{=BW_Player_UnlimitedSmithyStamina_Hint}Smithing never consumes stamina.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
        ...
        /// </summary>
        [SettingPropertyBool("{=BW_Player_MaxCharacterRelationship}Max Character Relationship", Order = 10, RequireRestart = false, HintText = "{=BW_Player_MaxCharacterRelationship_Hint}Any positive relationship change with player is boosted to +99.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
        ...
        /// </summary>
        [SettingPropertyBool("{=BW_Player_MaxAllCharacterRelationships}Max All Character Relationships", Order = 11, RequireRestart = false, HintText = "{=BW_Player_MaxAllCharacterRelationships_Hint}Instantly sets relationship to 100 with all characters.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
        ...
        /// Implemented in <see cref="Behaviors.PlayerCheatBehavior"/>.
        /// </summary>
        [SettingPropertyBool("{=BW_Player_InfiniteShipHealth}Infinite Ship HP", Order = 13, RequireRestart = false, HintText = "{=BW_Player_InfiniteShipHealth_Hint}Ships owned by the player's party never take damage. Requires War Sails DLC.")]
        [SettingPropertyGroup("{=BW_Category_Player}Player", GroupOrder = 0)]
